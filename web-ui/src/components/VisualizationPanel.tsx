    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-shrink-0 px-4 py-3 bg-surface-raised border-b border-surface-border flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold tracking-wide uppercase text-text-primary">3D Visualization</span>
          ...
          <div className="flex items-center gap-1.5 ml-2">
            ...
            <span className={`text-xs ${connectionStatus === 'connected' ? 'text-nv-green' : 'text-text-tertiary'}`}>
